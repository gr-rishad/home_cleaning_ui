...
class MainPageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MainPage(),
      routes: {
        '/calendarPage': (context) => CalendarPageSCreen(),
      },
    );
  }
}
...
class _MainPageState extends State<MainPage> {
  ...
  void changeFrequeny(String frequency) {
            ...
            Positioned(
              ...
              child: isSelected
                  ? Container(
                      ...
                      child: Center(
                        child: Icon(Icons.check_circle, color: pink),
                      ),
                    )
                  : Container(),
            )
